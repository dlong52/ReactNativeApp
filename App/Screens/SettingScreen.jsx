    ...
    <View className="p-5">
      <View>
        ...
        <View className="w-full h-[60px] bg-white flex-row items-center px-2 mt-2 rounded-md justify-between shadow-sm">
          {address &&
            <Text className="flex-1 leading-5 font-medium text-gray-500" >
      ...
      <View className="mt-3 ">
        ...
        {!showPhoneInput &&
          <View className="w-full h-[60px] bg-white shadow-sm flex-row items-center px-2 mt-2 rounded-md justify-between">
            {phoneNumber && <Text className="flex-1 leading-4 font-medium text-gray-500" >(+84) {phoneNumber.slice(1)}</Text>}
            <TouchableOpacity
              className="p-2"
