  ...
  return (
    <View className="p-5">
      ...
      <View className="mt-3 ">
        ...
        {!showPhoneInput && <View className="w-full h-[60px] bg-white shadow-sm flex-row items-center px-2 mt-2 rounded-md justify-between">
        ...
        {showPhoneInput && <View className="mt-2">
          <TextInput
            className="h-[55px] w-full border border-gray-400 rounded-md pl-2 mt-1"
            placeholder='+84'  
